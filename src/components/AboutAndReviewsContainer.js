...
const AboutCard = styled('div')(({ theme }) => ({
  ...
  [theme.breakpoints.down('sm')]: {
    width: '80%', // Ensure consistency with the below cards
  },
}));
...
const CardsContainer = styled('div')(({ theme }) => ({
  ...
  [theme.breakpoints.down('md')]: {
    ...
    gap: '10px', // Reduce gap when stacked vertically
  },
  [theme.breakpoints.down('sm')]: {
    width: '80%', // Ensure consistency with the About card
  },
}));
...
const ReviewCard = styled(Card)(({ theme }) => ({
  ...
  margin: '10px 10px', // Reduce margin to avoid large gaps
  boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)',
  [theme.breakpoints.down('sm')]: {
