...
`;
    ...
    const AboutPageMainContent = () => {
        const cards = [
          { description: "We begin by understanding your business and brand, ensuring our strategies align with your goals and resonate with your audience.", href: '#card1', image: '/Images/1.png' },
          { description: "We analyze competitors and industry trends to develop SEO strategies that position you effectively from the start.", href: '#card2', image: '/Images/2.png' },
          { description: "We create a wireframe and sitemap, integrating your ideas seamlessly into the design.", href: '#card3', image: '/Images/3.png' },
          { description: "We bring your design to life with a functional prototype, allowing for review and testing before the final launch.", href: '#card4', image: '/Images/4.png' },
          { description: "We transition your site to the live server, conducting extensive testing to ensure a flawless launch.", href: '#card5', image: '/Images/5.png' },
          { description: "After launch, we continuously monitor and optimize to enhance your search ranking, user experience, and revenue.", href: '#card6', image: '/Images/6.png' },
        ];
